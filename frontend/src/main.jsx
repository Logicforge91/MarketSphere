...
createRoot(document.getElementById("root")).render(
  <React.StrictMode>
    <AppErrorBoundary>
      <BrowserRouter>
        <LocalizationProvider><AccessibilityProvider><PrivacyProvider><AuthProvider><ShopProvider><ApplicationEntry><App /></ApplicationEntry></ShopProvider></AuthProvider></PrivacyProvider></AccessibilityProvider></LocalizationProvider>
      </BrowserRouter>
    </AppErrorBoundary>
  </React.StrictMode>,
);
